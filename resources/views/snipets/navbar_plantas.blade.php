<nav class="{{$fondo_negro}}">
    ...
    <ul class="{{$nav_list}}" id="nav-list">
        <li class="nav-list-li"><a href="{{url('/#caracteristicas')}}" class="nav-list-item {{$texto_blanco}}">PROYECTO</a></li>
        <li class="nav-list-li"><a href="{{url('/#location')}}" class="nav-list-item {{$texto_blanco}}">UBICACIÓN</a></li>
        <li class="nav-list-li"><a href="{{url('/#departments')}}" class="nav-list-item {{$texto_blanco}}">DEPARTAMENTOS</a></li>
