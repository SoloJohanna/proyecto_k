<div class="encabezado encabezado__negro color__blanco">
    <div class="encabezado__container contenedor">
        ...
        <div class="encabezado__botones">
            <a href="" class="encabezado__boton__uno__plantas">Un nuevo <strong>estándar de vida </strong> en <img src="{{asset('img/alfiler.png')}}" alt="" width="16px">Quinta Junge</a>
            <div class="encabezado__plantas__boton__dos" id="encabezadoPlantasBotonDos">
                ...
                <svg class="encabezado-plantas-flecha-abajo" id="encabezado-plantas-flecha-abajo" width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path id="svgPathPlantasFlechaAbajo" d="M15.3102 9.16607L8.19906 16.2772M8.19906 16.2772L1.08795 9.16607M8.19906 16.2772V2.05496" stroke="white" stroke-width="1.33333"/>
                </svg> 
            </div>
        </div>
    </div>
