...
<body>
    <div class="container">
    @include('snipets.navbar', ['link_proyecto'=>'#caracteristicas-pisos', 'link_ubicacion'=>'#schedules', 'link_departamentos'=>'#equipment-plantas', 'nav_negro'=>'nav-negro', "nav_negro_item"=>'nav-logo-negro', "nav_list_item"=>"nav-list-item-negro", "nav_item"=>"nav-item-negro", "icons"=>"icons-negro"])
