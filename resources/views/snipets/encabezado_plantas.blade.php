<div class="encabezado encabezado-negro fondo-negro color-blanco">
        ...
        <div class="encabezado-botones">
            ...
            <div class="encabezado-plantas-boton-dos" id="encabezadoBotonDos">
                ...
                <svg class="encabezado-plantas-flecha-abajo" width="17" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path id="svgPathFlechaAbajo" d="M15.3102 9.16607L8.19906 16.2772M8.19906 16.2772L1.08795 9.16607M8.19906 16.2772V2.05496" stroke="white" stroke-width="1.33333"/>
                </svg> 
            </div>
        </div>
    </div>
    <picture class="carrusel-off">
        <ul>
            <li>
